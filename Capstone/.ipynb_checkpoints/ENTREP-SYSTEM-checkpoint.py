...
class main():
	def __init__(self, root):
		self.root = root
		self.root.title('Points Canteen System')
		...
		self.title_label = Label(self.root, text='Points Canteen System', font=("calibri",30, 'bold'))
		self.welcome_label = Label(self.root, text='Welcome to Zeus Tech', font=("calibri",15))
...
To cancel an order, select the order from the left a and click the Remove button. Press the Proceed button to confirm your order.""", font=("calibri",12))
	...
	def show_receipt(self, discount_code, total_amount, real_amount, paid_money, mode_code, schedule_code, number_code):
		...
		self.receipt_content.append('{:^50}'.format('Points Canteen'))
